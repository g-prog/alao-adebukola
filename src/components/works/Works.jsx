...
export default function Works() {
  ...
  const data = [
...

    {
      ...
      desc: " I set up a Nodejs server using the Strapi Content Management System and utilized the REST API's generated therein in the frontend using a combination of Axios, React's useFetch, useState and useEffect, useParams hooks to build a web application where users can view available destinations from an API, seach for destinations and book destinations.",
